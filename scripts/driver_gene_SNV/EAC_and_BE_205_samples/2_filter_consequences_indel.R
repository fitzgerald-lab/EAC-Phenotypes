#================================================================#
#================================================================#
######  Script filter out insignificant types of Indel and duplicates
######  Input: combined_indel_consequences.csv, filter_list.txt
######  Output: consequence_indel_211_samples_filtered_unique_2.csv
#================================================================#
#================================================================#
...
file_path <- "/path/to/samples_211/combined_indel_consequences.csv"
included_variation_file <- "/path/to/filter_list.txt"
output_dir <- "/path/to/results/samples_211/"
sequence_id_file_path <- "/path/to/aks_trio_ross_noora/sequence_id_211.txt"
...
print(colnames(filtered_data_df))
...
filtered_data_df <- filtered_data_df %>%
  ...
  ungroup()
#write.xlsx(filtered_data_df, file = paste0(output_dir, "consequence_indel_146_samples_filtered.xlsx"))
...
filtered_data_df_unique$variation <- 'indel'
write.csv(filtered_data_df_unique, file = paste0(output_dir, "consequence_indel_211_samples_filtered_unique_2.csv"))
