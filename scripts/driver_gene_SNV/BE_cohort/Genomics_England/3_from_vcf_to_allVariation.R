...
vcf_files_dir <- "/scratchb/stlab-icgc/users/wu04/project/bo_gene_list/data/gel/snv_hg19_filter_pass"
output_dir <- "/scratchb/stlab-icgc/users/wu04/project/bo_gene_list/results"
