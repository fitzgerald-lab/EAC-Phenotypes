...
#=====================================================================#
######                                                           
######  Script calculate the number of samples and clusters per patient
######                                                           
#=====================================================================#
#=====================================================================#
...
result_dir <- "/mnt/scratchc/stlab-icgc/users/wu04/project/bo_gene_list/results/phylogenetic_tree/Trees_structure"
