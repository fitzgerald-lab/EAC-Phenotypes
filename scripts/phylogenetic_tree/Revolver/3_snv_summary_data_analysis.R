...
#=====================================================================#
######                                                           
######  Script the index from Revolver cohort summary data, such as truncal SNVs
######         number of driver SNVs, number of clones with drivers                    
#=====================================================================#
#=====================================================================#
...
# filter patient "PL_176" & "AH_412", because these two patients don't have clonal CCF -- the CNA looks not right, probably from insufficient ASCAT QC
data_df <- data_df %>% filter(patientID != "BE_AH_412" & patientID != "BE_PL_176")
