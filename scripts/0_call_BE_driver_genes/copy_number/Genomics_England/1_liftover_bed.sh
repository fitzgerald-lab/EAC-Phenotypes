...
BED_DIR="/scratchb/stlab-icgc/users/wu04/project/bo_gene_list/data/gel/cna_canvas_pass"

# Directory to output lifted BED files
OUTPUT_DIR="/scratchb/stlab-icgc/users/wu04/project/bo_gene_list/data/gel/cna_canvas_pass_hg19"
...
for bed_file in "$BED_DIR"/*.bed; do
    ...
    # Perform liftover
    /scratchb/stlab-icgc/users/wu04/project/bo_gene_list/scripts/liftover/liftOver "$bed_file" "$CHAIN_FILE" "$output_file" "$unmapped_file"
done
