#================================================================#
# Script: Adjust CNA Values to Seg.CN (log2() -1 of copy number) required by GISTIC2
# Author: Lianlian Wu
# Date: 2024-04-30
# Description:
...
for (i in seq_along(ploidy_files)) {
    ...
    adjusted_filename <- sub("copynumber.caveman.csv$", "copynumber.caveman_loged.csv", cna_data_path)
