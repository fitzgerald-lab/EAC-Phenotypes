#===========================================================================================
#===========================================================================================      
######   Script generate SNV consequences for dNdS input   
######   Input: .snp.pass.vep files          
######   Output: combined_vep_data.csv                                                                    
#===========================================================================================
#===========================================================================================
...
source_dir <- "/scratchb/stlab-icgc/users/wu04/project/bo_gene_list/data/aks_trio_ross_noora/snp/"
output_dir <- "/scratchb/stlab-icgc/users/wu04/project/bo_gene_list/results/samples_211/"

vep_files <- list.files(source_dir, pattern = "\\.snp.pass.vep$", full.names = TRUE)
...
process_vep_file <- function(file_path) {
  ...
  pattern_ <- "__pv.*__rg.grch37_g1k__al.bwa_mem__.snp.pass.vep"
...
write.csv(all_vep_data, paste0(output_dir, "combined_vep_data.csv"), row.names = FALSE)
