...
file_path <- "/output/from/1_from_vcf_to_allVariation.R/combined_consequences.csv"
included_variation_file <- "./data/genomic/call_BE_driver_genes/filter_list.txt"
output_dir <- "./results/"
...
write.csv(filtered_data_df_unique, file = paste0(output_dir, "consequence_filtered_unique.csv"))
